...
export const featuredProjects: Project[] = [
  {
    ...
    images: [
      ...
      { src: "/images/gcc/registration.jpeg", alt: "Tournament registration hub", width: 2560, height: 1482 },
      { src: "/images/gcc/add-players-mobile.jpeg", alt: "Add players mobile flow", width: 931, height: 1600 },
      { src: "/images/gcc/matches-admin.jpeg", alt: "Admin matches dashboard", width: 2560, height: 1468 },
      { src: "/images/gcc/bracket.jpeg", alt: "Knockout bracket view", width: 2560, height: 1468 },
  ...
  },
  {
    ...
    images: [
      { src: "/images/nexapos/dashboard.jpeg", alt: "NexaPOS dashboard", width: 2560, height: 1471 },
      { src: "/images/nexapos/billing.jpeg", alt: "NexaPOS billing screen", width: 2560, height: 1475 },
      { src: "/images/nexapos/products.jpeg", alt: "NexaPOS product catalogue", width: 2560, height: 1471 },
      { src: "/images/nexapos/reports.jpeg", alt: "NexaPOS analytics reports", width: 2560, height: 1469 },
      { src: "/images/nexapos/receipt.jpeg", alt: "NexaPOS receipt output", width: 2560, height: 1468 },
    ],
  },
  {
